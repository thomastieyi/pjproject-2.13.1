 ...
 * ```
 * Example EVS Codec SDP
 * INVITE sip:01012240001@192.168.1.235:5060;ob SIP/2.0
 * Record-Route: <sip:mt@172.22.0.21;lr=on;ftag=pxuYm4RKAvV3z3;rm=7;did=f17.9501>
 * Record-Route: <sip:mt@172.22.0.20:6060;lr=on;ftag=pxuYm4RKAvV3z3;did=f17.c1e1>
 * Record-Route: <sip:mo@172.22.0.20:6060;r2=on;lr=on;ftag=pxuYm4RKAvV3z3;did=f17.b1e1>
 * 
 * Record-Route: <sip:mo@172.22.0.20:6060;transport=tcp;r2=on;lr=on;ftag=pxuYm4RKAvV3z3;did=f17.b1e1>
 * Record-Route: <sip:mo@172.22.0.21;r2=on;lr=on;ftag=pxuYm4RKAvV3z3;rm=8;did=f17.8501>
 * Record-Route: <sip:mo@172.22.0.21;transport=tcp;r2=on;lr=on;ftag=pxuYm4RKAvV3z3;rm=8;did=f17.8501>
 * Via: SIP/2.0/TCP 172.22.0.21;branch=z9hG4bK6abe.6c4d2429c343921ac592384cf5f98251.0
 * Via: SIP/2.0/UDP 172.22.0.20:6060;branch=z9hG4bK6abe.3e0b0c1634d9cd1edacb2a378b3b1440.0
 * Via: SIP/2.0/UDP 172.22.0.19:4060;branch=z9hG4bK6abe.1d94d8adaaa0bcbd5477b1dd6de25114.1
 * Via: SIP/2.0/UDP 172.22.0.20:6060;branch=z9hG4bK6abe.78d45bae66256ea349a7b3f16f2f00a2.0;i=1
 * Via: SIP/2.0/TCP 172.22.0.21;branch=z9hG4bK6abe.cbc73e8f1844b780c7492106a158cf25.0;i=3
 * Via: SIP/2.0/TCP 192.168.101.2;rport=65449;branch=z9hG4bKosSWYEA93MWapm
 * From: <sip:01012240004@ims.mnc001.mcc001.3gppnetwork.org>;tag=pxuYm4RKAvV3z3
 * Contact: <sip:01012240004@192.168.101.2:5060;alias=192.168.101.2~65449~2;transport=tcp>;+sip.instance="<urn:gsma:imei:86990905-827666-0>";+g.3gpp.icsi-ref="urn%3Aurn-7%3A3gpp-service.ims.icsi.mmtel";audio;+g.3gpp.mid-call;+g.3gpp.srvcc-alerting;+g.3gpp.ps2cs-srvcc-orig-pre-alerting
 * To: <tel:01012240001;phone-context=ims.mnc001.mcc001.3gppnetwork.org>
 ...
 * CSeq: 28 INVITE
 * Call-ID: osfmFkGM7wrjdHpfNLB
 * Session-Expires: 60000
 * Min-SE: 1800
 * Content-Type: application/sdp
 * P-Access-Network-Info: 3GPP-NR-TDD;utran-cell-id-3gpp=001010000010000019B0
 * Content-Length: 607
 * P-Charging-Vector: icid-value=495653AC160015900000009800000000; icid-generated-at=172.22.0.21
 * P-Visited-Network-ID: ims.mnc001.mcc001.3gppnetwork.org
 * P-Asserted-Identity: <sip:01012240004@ims.mnc001.mcc001.3gppnetwork.org>
 * 
 * v=0
 * o=- 656 656 IN IP4 172.22.0.16
 * s=mtk voice call
 ...
 * b=RR:1537
 * t=0 0
 * m=audio 49000 RTP/AVP 127 98 97 105 100
 * b=AS:41
 * b=RS:512
 * b=RR:1537
 * a=maxptime:240
