                                   ...
                                   const pj_str_t *method)
{
         ...
         pj_stricmp(&chal->algorithm, &pjsip_AKAv1_MD5_STR)==0))
    {
        ...
        PJ_LOG(4,(THIS_FILE, "Nouce is \"%.*s\"",
                  chal->nonce.slen, chal->nonce.ptr));
    }
    else {
    ...
    if (chal->qop.slen == 0) {
         ...
         */
        PJ_LOG(4,(THIS_FILE, "Server requires quality of protection"));
        ...
        if ((cred_info->data_type & EXT_MASK) == PJSIP_CRED_DATA_EXT_AKA) {
            ...
            if (algo_sha256) {
                ...
                PJ_LOG(4,(THIS_FILE, "pjsip_auth_create_digest begin"));
                ...
                status = pjsip_auth_create_digest( &cred->response, 
                                          ...
                                          uri, &chal->realm, 
                                          cred_info, method);
                PJ_LOG(4,(THIS_FILE, "pjsip_auth_create_digest ended"));
            }
        }
