export PJDIR := /Users/wangdong/imsclient/pjproject-2.13.1
...
export TARGET_ARCH := 
export STD_CPP_LIB := 
export TARGET_NAME := arm-apple-darwin22.1.0
...
# SDL flags
SDL_CFLAGS = -DPJMEDIA_VIDEO_DEV_HAS_SDL=1 -I/opt/homebrew/include/SDL2 -D_THREAD_SAFE
SDL_LDFLAGS = -L/opt/homebrew/lib -lSDL2

# FFMPEG flags
FFMPEG_CFLAGS =  -DPJMEDIA_HAS_LIBAVDEVICE=1 -DPJMEDIA_HAS_LIBAVFORMAT=1 -DPJMEDIA_HAS_LIBAVCODEC=1 -DPJMEDIA_HAS_LIBSWSCALE=1 -DPJMEDIA_HAS_LIBAVUTIL=1 -I/opt/homebrew/Cellar/ffmpeg/5.1.2/include -DPJMEDIA_USE_OLD_FFMPEG=1 
FFMPEG_LDFLAGS =   -L/opt/homebrew/Cellar/ffmpeg/5.1.2/lib -lavdevice -lavformat -lavcodec -lswscale -lavutil
...
export APP_CFLAGS := -DPJ_AUTOCONF=1\
        -O2 -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1 -I/Users/wangdong/imsclient/pjproject-2.13.1/include\
        $(PJ_VIDEO_CFLAGS) \
...
export APP_LDFLAGS := -L$(PJDIR)/pjlib/lib\
        ...
        $(PJ_VIDEO_LDFLAGS) \
         -L/Users/wangdong/imsclient/pjproject-2.13.1/lib
...
export APP_LDLIBS := $(PJSUA_LIB_LDLIB) \
        ...
        $(APP_THIRD_PARTY_EXT)\
        $(PJLIB_LDLIB) \
        -lopus -lssl -lcrypto -lm -lpthread  -framework CoreAudio -framework CoreServices -framework AudioUnit -framework AudioToolbox -framework Foundation -framework AppKit -framework AVFoundation -framework CoreGraphics -framework QuartzCore -framework CoreVideo -framework CoreMedia -framework VideoToolbox -L/opt/homebrew/lib -lSDL2  -L/opt/homebrew/Cellar/ffmpeg/5.1.2/lib -lavdevice -lavformat -lavcodec -lswscale -lavutil -L/opt/homebrew/Cellar/gnutls/3.8.0/lib -lgnutls -lopencore-amrnb -lopencore-amrwb -lvo-amrwbenc
...
export PJ_INSTALL_LDFLAGS_PRIVATE := $(APP_THIRD_PARTY_LIBS) $(APP_THIRD_PARTY_EXT) -lopus -lssl -lcrypto -lm -lpthread  -framework CoreAudio -framework CoreServices -framework AudioUnit -framework AudioToolbox -framework Foundation -framework AppKit -framework AVFoundation -framework CoreGraphics -framework QuartzCore -framework CoreVideo -framework CoreMedia -framework VideoToolbox -L/opt/homebrew/lib -lSDL2  -L/opt/homebrew/Cellar/ffmpeg/5.1.2/lib -lavdevice -lavformat -lavcodec -lswscale -lavutil -L/opt/homebrew/Cellar/gnutls/3.8.0/lib -lgnutls -lopencore-amrnb -lopencore-amrwb -lvo-amrwbenc
